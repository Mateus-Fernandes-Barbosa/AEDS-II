...
public class Ex1{
	...
	public static void executaComando(int cmd, String str1, String str2) throws Exception{
		...
		switch(cmd){
			case 0:
				//num = leia.next();
				listaJogadores.inserirInicio(temp.criaArray(Integer.parseInt(num)));
				break;
			case 1:
				//num = leia.next();
				//pos = leia.next();
				listaJogadores.inserir(temp.criaArray(Integer.parseInt(num)), Integer.parseInt(pos));
				break;
			case 2:
				//num = leia.next();
				listaJogadores.inserirFim(temp.criaArray(Integer.parseInt(num)));
				break;
			case 3:
		...
		if(resp != null){
			listaExcluidos.inserirFim(resp);
			listaExcluidos.AumentarTamArray();
		}
	}
	...
	public static void main(String [] args) throws Exception{
		...
		for(int i = 0; !entrada.equals("FIM"); i++){
			listaJogadores.inserirFim(jogador.criaArray(Integer.parseInt(entrada)));
			entrada = leia.nextLine();
		}
		...
		for(int j = 0; j < listaExcluidos.getN(); j++){
			System.out.println("(R) " + listaExcluidos.getElemento(j).getNome());
		}
		for(int i = 0; i < listaJogadores.getN(); i++){
			System.out.println("[" + i + "]"
					+ jogador.toString(listaJogadores.getElemento(i).getId()));
		}
        }
}
