...
class No2 {
     ...
     */
    public No2(Jogador elemento, No esq, No dir) {
...
class ArvoreBinaria {
	 ...
	 * <code>false</code> em caso contrario.
	 */
	private boolean pesquisar(Jogador y, No i) {
      boolean resp;
      int altura = y.getAltura();
      int x = altura % 15;
      if (i == null) {
         resp = false;

      } else if (x == i.elemento) {
         resp = No.arvore.pesquisar(x);
	...
	/**
         ...
         * <code>false</code> em caso contrario.
         */
        private boolean pesquisar(int y, No i) {
	int x = y % 15;
      boolean resp;
      if (i == null) {
         resp = false;
...
class No {
    ...
    public No(Jogador elemento, No esq, No dir) {
        ...
        this.elemento = elemento.getAltura();
        this.esq = esq;
        this.dir = dir;
	this.arvore.inserir(elemento);
    }
