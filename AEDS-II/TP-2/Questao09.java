...
class Jogador{
    ...
    public void HeapSort(){
      ...
      Jogador[] tmp = new Jogador[tamArray+1];
      for(int i = 0; i < tamArray; i++){
         tmp[i+1] = array[i];
      }
      array = tmp;
      ...
      //Contrucao do heap
      for(int tamHeap = 2; tamHeap <= tamArray; tamHeap++){
         construir(tamHeap);
      }

      //Ordenacao propriamente dita
      int tamHeap = tamArray;
      while(tamHeap > 1){
         swap(1, tamHeap--);
         reconstruir(tamHeap);
      }
    ...
    public void OrganizaOrganizado(String parametro){
      switch(parametro){
        case "ano":
        for(int i = 1; i < tamArray; i++){
        Jogador temp = array[i];
        ...
        int j = i - 1;
          if(array[j].getNome().charAt(0) > array[i].getNome().charAt(0)){
              while((j >= 0) && (array[j].getPeso() == temp.getPeso()) &&                          array[j].getNome().compareTo(temp.getNome()) > 0){
              array[j + 1] = array[j];
              j--;
              }
          }
        ...
        int j = i - 1;
          if(array[j].getNome().charAt(0) > array[i].getNome().charAt(0)){
              while((j >= 0) && (array[j].getUniversidade() == temp.getUniversidade()) &&                          array[j].getNome().compareTo(temp.getNome()) > 0){
              array[j + 1] = array[j];
              j--;
              }
          }
        ...
        int j = i - 1;
          if(array[j].getNome().charAt(0) > array[i].getNome().charAt(0)){
              while((j >= 0) && (array[j].getEstado() == temp.getEstado()) &&                          array[j].getNome().compareTo(temp.getNome()) > 0){
              array[j + 1] = array[j];
              j--;
              }
          }
        ...
        int j = i - 1;
          if(array[j].getNome().charAt(0) > array[i].getNome().charAt(0)){
              while((j >= 0) && (array[j].getCidade() == temp.getCidade()) &&                          array[j].getNome().compareTo(temp.getNome()) > 0){
              array[j + 1] = array[j];
              j--;
              }
          }
    ...
    jogador.HeapSort();
    jogador.OrganizaOrganizado("altura");
